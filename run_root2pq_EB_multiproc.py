...
date_str = '190903_225259'
#date_str = '190903_225324'
#date_str = '190903_225342'
...
if wgt_files is not None:
  ...
  processes = []
  for it,i in enumerate(range(0, len(rhFileList), 200)):
    rhFileList_batch = rhFileList[i:i+200]
    #print(it, i, i+200, len(rhFileList_batch))
