...
eosDir='/eos/uscms/store/user/lpcml/mandrews/2017/EEGuns_v1'
#eosDir='/eos/uscms/store/user/lpcml/mandrews'

decay = 'DoublePi0Pt10To200_m0To2600_Eta1p5To2p4_noPU_AODSIM_EE_ES_EEatES_TkatES'
date_str = '191022_225121'
...
proc_file = 'convert_root2pq_ESshower.py'
if wgt_files is not None:
